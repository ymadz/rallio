  ...
  useEffect(() => {
    async function load() {
      ...
      if (availableItems.length === 0) {
        setError(
          'All items in your cart are currently unavailable. Please review your cart first.'
        );
        setIsHydrating(false);
        return;
      }
    ...
    return (
      <div className="max-w-2xl mx-auto mt-12 p-8 bg-white rounded-2xl shadow-sm border border-gray-100 text-center">
        ...
        <p className="text-gray-500 mb-6">
          Looks like you haven't added any courts to your cart yet.
        </p>
        <button
          onClick={() => {
            resetCheckout();
        ...
        <div className="flex items-start gap-3 text-amber-800">
          ...
          <div>
            ...
            <p className="text-sm mt-1">
              Some cart slots are unavailable. Remove those slots in the cart drawer, then continue
              checkout.
            </p>
            <button
              onClick={() => {
