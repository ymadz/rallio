                  ...
                  <div className="flex flex-col gap-2 pt-4 border-t border-gray-200">
                    ...
                    <div className="flex gap-4 pt-2">
                      <div className="flex-1 flex flex-col gap-1.5">
                        <Link href={`/courts/${booking.courts.venues.id}`} className="w-full">
                        ...
                        <span className="text-[10px] text-center text-gray-400 font-medium uppercase tracking-wide">Venue Info</span>
                      </div>
                      ...
                      <div className="flex-1 flex flex-col gap-1.5">
                        ...
                        <span className="text-[10px] text-center text-gray-400 font-medium uppercase tracking-wide">Download</span>
                      </div>
                      ...
                      {canCancelBooking(booking) && (
                        <div className="flex-1 flex flex-col gap-1.5">
                          ...
                          <span className="text-[10px] text-center text-red-400/70 font-medium uppercase tracking-wide">Action</span>
                        </div>
                      )}
                    </div>
                  </div>
