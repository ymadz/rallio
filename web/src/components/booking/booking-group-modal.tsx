              ...
              <div className="relative z-10">
                ...
                <div className="flex justify-between items-end">
                  <div className="max-w-[70%]">
                    <div className="flex items-center gap-2 mb-1">
                      <h2 className="text-xl font-bold text-white tracking-tight leading-tight">
                        {isQueueSession
                          ? 'Queue Session'
                          : group.type === 'grouped_recurring'
                            ? 'Recurring Series'
                            : 'Multi-Court Transaction'}
                      </h2>
                    </div>
                  ...
                  <div className="text-right">
                    <p className="text-[9px] uppercase font-bold tracking-[0.1em] text-white/50 mb-0.5">
                      Total Amount
                    </p>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4 relative z-10 w-full">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div
                            className={cn(
                              'text-[11px] transition-colors truncate max-w-[180px] font-medium',
              ...
              <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center shrink-0 bg-white">
                <div className="flex gap-4">
                  <div className="bg-gray-50 px-3 py-1.5 rounded-xl border border-gray-100">
                    <p className="text-gray-400 text-[8px] uppercase font-bold tracking-wider mb-0.5">
                      Paid
                    </p>
                    <p className="font-black text-teal-600 text-sm leading-none">
                      ₱{group.amountPaid.toFixed(0)}
                    </p>
                  </div>
                  {!isFullyPaid && (
                    <div className="bg-amber-50 px-3 py-1.5 rounded-xl border border-amber-100">
                      <p className="text-amber-400 text-[8px] uppercase font-bold tracking-wider mb-0.5">
                        Balance
                      </p>
                      <p className="font-black text-amber-600 text-sm leading-none">
                        ₱{(group.totalAmount - group.amountPaid).toFixed(0)}
                      </p>
                    </div>
                  )}
                </div>
            ...
            {selectedBooking ? (
              ...
              <div className="hidden sm:flex h-full w-full items-center justify-center p-12 text-center flex-col bg-gray-50/50">
                ...
                <p className="text-sm text-gray-500 max-w-[280px] leading-relaxed">
                  Select any slot from the list to view detailed information, receipts, or manage
                  the booking.
                </p>
              </div>
            )}
