                        ...
                        {calculatedPrice.discount !== 0 && calculatedPrice.appliedDiscounts && calculatedPrice.appliedDiscounts.length > 0 && (
                          <div className="flex flex-wrap gap-1 mt-1">
                            {calculatedPrice.appliedDiscounts.map((discount, idx) => (
                              <span key={idx} title={discount.description || discount.name} className={`text-xs font-medium px-2 py-1 rounded inline-flex flex-col gap-0.5 ${discount.isIncrease ? 'bg-orange-50 text-orange-700 border border-orange-100' : 'bg-green-50 text-green-700 border border-green-100'}`}>
                                ...
                                {discount.description && (
                                  <span className="text-[10px] font-normal leading-tight opacity-80 pl-4">{discount.description}</span>
                                )}
                              </span>
                            ))}
                          </div>
